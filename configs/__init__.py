...
def parse_args():
    ...
    # build dirs
    parser.add_argument('--data_dir', type=str, default="/home/rgpa18/ssan_datasets/mrc", help='YOUR_Data_Dir')
    ...
    parser.add_argument('--protocol', type=str, default="M_I_to_C", help='protocal')
